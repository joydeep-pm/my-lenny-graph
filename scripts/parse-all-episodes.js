...
/**
 * Parse all 302 episode transcripts from the episodes directory
...
function generateTypeScriptFile(episodes) {
  ...
  const ts = `// All 302 episode transcripts - COMPREHENSIVELY PARSED
...
// Main execution
try {
  console.log('🚀 Parsing all 302 episode transcripts...\n');
