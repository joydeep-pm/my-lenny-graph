...
/**
 * Parse all 296 episode transcripts from the episodes directory
...
function generateTypeScriptFile(episodes) {
  ...
  const ts = `// All 296 episode transcripts - COMPREHENSIVELY PARSED
...
// Main execution
try {
  console.log('🚀 Parsing all 296 episode transcripts...\n');
