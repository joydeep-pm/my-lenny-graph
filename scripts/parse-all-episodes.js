...
/**
 * Parse all 297 episode transcripts from the episodes directory
...
function generateTypeScriptFile(episodes) {
  ...
  const ts = `// All 297 episode transcripts - COMPREHENSIVELY PARSED
...
// Main execution
try {
  console.log('🚀 Parsing all 297 episode transcripts...\n');
