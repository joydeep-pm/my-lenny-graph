...
export const metadata: Metadata = {
  ...
  description: "Take a 10-question quiz and get podcast episode recommendations that match how you work as a PM. Built from 302 episodes of Lenny's Podcast with verified quotes.",
  ...
  openGraph: {
    ...
    description: "Get podcast episode recommendations that match how you work. Based on 302 episodes of Lenny's Podcast.",
